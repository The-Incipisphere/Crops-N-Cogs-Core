...
public class ModBlocks {
    public static final RegistryEntry<OreCropBlock> BECQUERELLIUM_CROP = REGISTRATE.block("becquerellium_crop", properties -> new OreCropBlock(ModPlants.Becquerellium, properties))
