...
public class Crop extends Plant {
    ...
    public Crop(Component displayName, PlantType plantType, PlantTextures plantTextures, Supplier<? extends BushBlock> plant, Supplier<? extends Item> essence, Supplier<? extends ItemNameBlockItem> seeds, Set<ResourceLocation> requiredBiomes) {
