...
public class BlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        LootItemCondition.Builder lootitemcondition$builder = LootItemBlockStatePropertyCondition
                .hasBlockStateProperties(CropRegistry.IRON_ORE_CROP.get())
                .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IronOreCrop.AGE, 5));

        this.add(CropRegistry.IRON_ORE_CROP.get(), createCropDrops(CropRegistry.IRON_ORE_CROP.get(), Items.IRON_ORE,
                CropRegistry.IRON_ORE_SEEDS.get(), lootitemcondition$builder));
